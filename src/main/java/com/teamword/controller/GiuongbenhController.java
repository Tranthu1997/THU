...
// tach ham addnew
 ...
 //Tach ham edit
    ...
    */
    ...
    @RequestMapping(value = "giuongbenh/get/{id}", method = RequestMethod.GET)
    public ResponseEntity<Giuongbenh> get(@PathVariable final Integer id){
        final Giuongbenh giuongbenh= 4
    }
